# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-07-12 15:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assert_type', models.CharField(choices=[('server', '服务器'), ('switch', '交换机'), ('router', '路由器'), ('firewall', '防火墙'), ('storage', '存储设备'), ('NLB', 'NetScaler'), ('wireless', '无线AP'), ('software', '软件资产'), ('others', '其它类')], default='server', max_length=64)),
                ...
                ('admin', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='userauth.UserProfile', verbose_name='资产管理员')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cmdb.Asset')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='userauth.UserProfile', verbose_name='事件源')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='userauth.UserProfile', verbose_name='批准人')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateField(auto_now_add=True)),
                ('creater', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='userauth.UserProfile')),
            ],
        ),
        migrations.AddField(
