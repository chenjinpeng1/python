...
class Article(models.Model):
    ...
    brief = models.CharField(null=True,blank=True,max_length=255,verbose_name='摘要')
    category = models.ForeignKey("Category",verbose_name='分类')
    content = models.TextField(u"文章内容")
    author = models.ForeignKey("UserProfile",verbose_name='用户')
...
class UserProfile(models.Model):
    ...
    signature= models.CharField(u'签名',max_length=255,blank=True,null=True)
    head_img = models.ImageField(u'头像',blank=True,null=True,upload_to="uploads")
    #for web qq
